...
public class DarkSkyHomePage extends BasePage {
    ...
    private By verifyMinTemerature = By.xpath("body.forecast:nth-child(2) div.center:nth-child(7) a.day:nth-child(2) span.tempRange:nth-child(2) > span.minTemp");
    private By verifyHighTemperature = By.xpath("body.forecast:nth-child(2) div.center:nth-child(7) a.day.revealed:nth-child(2) span.tempRange:nth-child(2) > span.maxTemp");
    ...
    public void setVerifyLowAndHighTempIsDisplayed(String rangTempDisplayed) {
        if(verifyMinTemerature == verifyLowerTemperature && verifyHighTemperature == verifyMaxTemperature) {
            System.out.println("I verify Lowest and Highest temperature is displayed correctly");
        }
